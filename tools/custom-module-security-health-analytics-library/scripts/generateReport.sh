...
if [ "$#" -ne 2 ]; then
  ...
  echo "  <output_csv_file>: The path where the output CSV should be saved (e.g., sha_policies_summary.csv)"
  echo ""
  echo "Example: $0 ./samples/gcloud/custom-sha policies_summary.csv"
  exit 1
fi
